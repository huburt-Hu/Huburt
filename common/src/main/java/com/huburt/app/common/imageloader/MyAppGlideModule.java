...
/**
 * 程序库一定 不要 包含 AppGlideModule 实现。这么做将会阻止依赖该库的任何应用程序管理它们的依赖，
 * 或配置诸如 Glide 缓存大小和位置之类的选项。此外，如果两个程序库都包含 AppGlideModule，
...
public final class MyAppGlideModule extends AppGlideModule {
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        builder.setDiskCache(new DiskLruCacheFactory(ContextProvider.getCacheDir().getAbsolutePath(), diskCacheSizeBytes));
    }
    ...
    private static class DispatchingProgressListener implements MyAppGlideModule.ResponseProgressListener {
